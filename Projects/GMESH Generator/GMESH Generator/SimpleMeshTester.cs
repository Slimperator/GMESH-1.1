...
{
    public partial class SimpleMeshTester : Form
    {
        public AbstractMesh mesh;
        public IContour con;
        public SimpleMeshTester()
        {
            InitializeComponent();
        }

        private void SimpleMeshTester_Shown(object sender, EventArgs e)
        {
            
        }

        private void SimpleMeshTester_Paint(object sender, PaintEventArgs e)
        {
            //тут рисуем сетку
